...
# Called by: GmailOrderReinstateAgent (agents/order_reinstate.py)
def order_reinstate_gmail_tool(session_id: Optional[str] = None):
    """
    Individual tools for order reinstate payload extraction using Gmail + petition.
    ...
    @tool()
    def extract_debtor_name_reinstate(query: str):
    ...
    @tool()
    def extract_case_number_reinstate(query: str):
    ...
    @tool()
    def extract_chapter_number_reinstate(query: str):
    ...
    @tool()
    def extract_judge_initial_reinstate(query: str):
        """
    ...
    @tool()
    def extract_case_number_reinstate_gmail(query: str):
    ...
    return [
        extract_debtor_name_reinstate,
        extract_case_number_reinstate,
        extract_chapter_number_reinstate,
        extract_judge_initial_reinstate,
        extract_case_number_reinstate_gmail,
    ]
